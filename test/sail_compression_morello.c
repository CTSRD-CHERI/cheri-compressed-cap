...
static void create_letbind_12(void) {    CREATE(lbits)(&zCAP_BOUND_MAX);
...
static void create_letbind_13(void) {    CREATE(lbits)(&zCAP_BOUND_MIN);
            ...
            CREATE(ztuple_z8z5bvzCz0z5bvzCz0z5boolz9)(&zgsz3283);
            {
              ...
              }
              {
                bool zgaz386;
                {
                  ...
                  zgsz3334 = sailgen_zzzz7NzzJzzK2z3CapUnsignedGreaterThan(zgaz384, UINT64_C(0b01));
