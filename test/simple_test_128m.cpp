...
TEST_CASE("Fast representability check sign extended", "[fuzz]") {
    ...
    TestAPICC::cap_t cap = TestAPICC::decompress_raw(0xa1a04fffffdff00, 0x01a4fe02410001ff, false);
...
TEST_CASE("Fast representability zero length no sign change", "[fuzz]") {
    ...
    TestAPICC::cap_t cap = TestAPICC::decompress_raw(0xffff000000000000, 0x0029ffffff85ffff, false);
