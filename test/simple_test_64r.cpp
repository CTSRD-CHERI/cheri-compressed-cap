...
// AP compression
//
TEST_CASE_AP_COMP(CAP_AP_R, (CC64R_AP_Q0 | 1))
TEST_CASE_AP_COMP(CAP_AP_W, (CC64R_AP_Q0 | 4))
TEST_CASE_AP_COMP(CAP_AP_R | CAP_AP_W, (CC64R_AP_Q0 | 5))

TEST_CASE_AP_COMP((CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C | CAP_AP_ASR), (CC64R_AP_Q1 | 0))
// TODO: mode TEST_CASE_AP_COMP((CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C | CAP_AP_ASR), (CC64R_AP_Q1 | 1))
TEST_CASE_AP_COMP((CAP_AP_X | CAP_AP_R | CAP_AP_C | CAP_AP_LM), (CC64R_AP_Q1 | 2))
// TODO: mode TEST_CASE_AP_COMP((CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_C), (CC64R_AP_Q1 | 3))
TEST_CASE_AP_COMP((CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C), (CC64R_AP_Q1 | 4))
// TODO: mode TEST_CASE_AP_COMP((CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C), (CC64R_AP_Q1 | 5))
TEST_CASE_AP_COMP((CAP_AP_X | CAP_AP_R | CAP_AP_W), (CC64R_AP_Q1 | 6))
// TODO: mode TEST_CASE_AP_COMP((CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W), (CC64R_AP_Q1 | 7))

TEST_CASE_AP_COMP(CAP_AP_C | CAP_AP_R | CAP_AP_LM, (CC64R_AP_Q3 | 3))
TEST_CASE_AP_COMP(CAP_AP_C | CAP_AP_R | CAP_AP_W | CAP_AP_LM, (CC64R_AP_Q3 | 7))

// Invalid permissions must result in "no permissions".
// TODO: TEST_CASE_AP_COMP(CAP_AP_C, 0);

//
// AP decompression
//
TEST_CASE_AP_DECOMP(CC64R_AP_Q0 | 1, CAP_AP_R)
TEST_CASE_AP_DECOMP(CC64R_AP_Q0 | 4, CAP_AP_W)
TEST_CASE_AP_DECOMP(CC64R_AP_Q0 | 5, (CAP_AP_R | CAP_AP_W))
// invalid in Q0 -> no permissions
TEST_CASE_AP_DECOMP(CC64R_AP_Q0 | 6, 0)

TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 0), (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C | CAP_AP_ASR))
// TODO: mode TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 1), (CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C |
// CAP_AP_ASR))
TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 2), (CAP_AP_X | CAP_AP_R | CAP_AP_C))
// TODO: mode TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 3), (CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_C))
TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 4), (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C))
// TODO: mode TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 5), (CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_C))
TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 6), (CAP_AP_X | CAP_AP_R | CAP_AP_W))
// TODO: mode TEST_CASE_AP_DECOMP((CC64R_AP_Q1 | 7), (CAP_AP_M | CAP_AP_X | CAP_AP_R | CAP_AP_W))

// invalid in Q2 -> no permissions
TEST_CASE_AP_DECOMP((CC64R_AP_Q2 | 2), 0)

TEST_CASE_AP_DECOMP((CC64R_AP_Q3 | 3), CAP_AP_C | CAP_AP_R)
TEST_CASE_AP_DECOMP((CC64R_AP_Q3 | 7), CAP_AP_C | CAP_AP_R | CAP_AP_W)
// invalid in Q3 -> no permissions
TEST_CASE_AP_DECOMP((CC64R_AP_Q3 | 1), 0)
