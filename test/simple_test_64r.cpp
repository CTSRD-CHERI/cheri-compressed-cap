...
// AP compression
//
TEST_CASE_M_AP_COMP(0, CAP_AP_R, (CC64R_AP_Q0 | 1))
TEST_CASE_M_AP_COMP(0, CAP_AP_W, (CC64R_AP_Q0 | 4))
TEST_CASE_M_AP_COMP(0, CAP_AP_R | CAP_AP_W, (CC64R_AP_Q0 | 5))

TEST_CASE_M_AP_COMP(0, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C | CAP_AP_ASR), (CC64R_AP_Q1 | 0))
TEST_CASE_M_AP_COMP(1, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C | CAP_AP_ASR), (CC64R_AP_Q1 | 1))
TEST_CASE_M_AP_COMP(0, (CAP_AP_X | CAP_AP_R | CAP_AP_C | CAP_AP_LM), (CC64R_AP_Q1 | 2))
TEST_CASE_M_AP_COMP(1, (CAP_AP_X | CAP_AP_R | CAP_AP_C | CAP_AP_LM), (CC64R_AP_Q1 | 3))
TEST_CASE_M_AP_COMP(0, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C), (CC64R_AP_Q1 | 4))
TEST_CASE_M_AP_COMP(1, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C), (CC64R_AP_Q1 | 5))
TEST_CASE_M_AP_COMP(0, (CAP_AP_X | CAP_AP_R | CAP_AP_W), (CC64R_AP_Q1 | 6))
TEST_CASE_M_AP_COMP(1, (CAP_AP_X | CAP_AP_R | CAP_AP_W), (CC64R_AP_Q1 | 7))

TEST_CASE_M_AP_COMP(0, CAP_AP_C | CAP_AP_R, (CC64R_AP_Q2 | 3))

TEST_CASE_M_AP_COMP(0, CAP_AP_C | CAP_AP_R | CAP_AP_LM, (CC64R_AP_Q3 | 3))
TEST_CASE_M_AP_COMP(0, CAP_AP_C | CAP_AP_R | CAP_AP_W | CAP_AP_LM, (CC64R_AP_Q3 | 7))

// Invalid permissions must result in "no permissions".
// TODO: TEST_CASE_M_AP_COMP(0, CAP_AP_C, 0);
...
TEST_CASE_M_AP_DECOMP((CC64R_AP_Q1 | 2), 0, (CAP_AP_X | CAP_AP_R | CAP_AP_C | CAP_AP_LM))
TEST_CASE_M_AP_DECOMP((CC64R_AP_Q1 | 3), 1, (CAP_AP_X | CAP_AP_R | CAP_AP_C | CAP_AP_LM))
TEST_CASE_M_AP_DECOMP((CC64R_AP_Q1 | 4), 0, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C))
TEST_CASE_M_AP_DECOMP((CC64R_AP_Q1 | 5), 1, (CAP_AP_X | CAP_AP_R | CAP_AP_W | CAP_AP_LM | CAP_AP_C))
TEST_CASE_M_AP_DECOMP((CC64R_AP_Q1 | 6), 0, (CAP_AP_X | CAP_AP_R | CAP_AP_W))
